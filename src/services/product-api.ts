...
const mockProducts: Product[] = [
  // Existing Products (Updated Images)
  {
    ...
    description:
      "High-performance laptop for professionals and creatives. Sleek design, powerful internals.",
    price: 1499.99,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Absolutely stunning machine. Fast, light, and beautiful display.",
      ...
      },
      {
        ...
        author: "Bob White",
        rating: 4,
        comment: "Very good laptop, but gets a bit warm under heavy load.",
  ...
  },
  {
    ...
    description:
      "The latest flagship smartphone with an amazing camera system and AI features.",
    price: 1199.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Best phone camera I have ever used. Blazing fast too!",
  ...
  },
  {
    ...
    description:
      "Industry-leading noise cancellation and immersive audio experience.",
    price: 349.0,
    imageUrl:
      "https://picsum.photos/seed/headphones_quietcomfort_ultra_main/600/400",
    gallery: [
    ...
    reviews: [
      {
        ...
        author: "Diana Prince",
        rating: 5,
        comment: "The noise cancellation is magic! Perfect for flights.",
      ...
      },
      {
        ...
        author: "Ethan Hunt",
        rating: 4,
        comment: "Great sound and comfort, but the app could be better.",
        date: "2024-05-05T18:45:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Comfortable and precise wireless mouse designed for long hours of use.",
    price: 79.99,
    imageUrl: "https://picsum.photos/seed/mouse_ergo_wireless_main/600/400",
    gallery: ["https://picsum.photos/seed/mouse_ergo_wireless_a/800/600"],
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Finally, a mouse that doesn't hurt my wrist!",
        date: "2024-04-28T16:15:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Full-frame mirrorless camera for hybrid shooters, excelling in both photo and video.",
    price: 2499.0,
    ...
    reviews: [
      {
        id: "r5-1",
        author: "Giselle Yashar",
        rating: 5,
        comment: "Incredible image quality and autofocus performance.",
  ...
  },
  {
    ...
    name: "GamerForce X17",
    description:
      "Ultimate gaming laptop with top-tier graphics and high refresh rate display.",
    price: 2199.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Plays everything on ultra settings smoothly. The screen is gorgeous!",
  ...
  },
  {
    ...
    name: "Pixel 9a",
    description:
      "Affordable smartphone with Google's excellent camera software and clean Android experience.",
    price: 499.0,
    imageUrl: "https://picsum.photos/seed/phone_pixel_9a_main/600/400",
    gallery: ["https://picsum.photos/seed/phone_pixel_9a_a/800/600"],
    category: "Smartphones",
    brand: "Googol",
    stock: 150,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        author: "Jack Reacher",
        rating: 4,
        comment: "Amazing camera for the price. Performance is decent.",
        date: "2024-05-14T13:10:00Z",
      },
      {
        id: "r7-2",
        author: "Kara Zor-El",
        rating: 5,
        comment: "Best budget phone, hands down.",
  ...
  },
  {
    ...
    description:
      "True wireless earbuds with strong noise cancellation and long battery life.",
    price: 99.99,
    ...
    reviews: [
      {
        ...
        author: "Leo Fitz",
        rating: 5,
        comment: "Incredible value. ANC rivals much more expensive earbuds.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Fit is good, sound is great. ANC is impressive for the price.",
  ...
  },
  {
    ...
    name: "Surface Pro 10",
    description:
      "Versatile 2-in-1 tablet/laptop with a stunning display and powerful performance.",
    price: 1099.99,
    ...
    reviews: [
      {
        ...
        author: "Nick Fury",
        rating: 4,
        comment: "Great for productivity on the go. Keyboard is a must-have.",
  ...
  },
  {
    ...
    name: "PlayStation 6",
    description:
      "Next-generation gaming console with breathtaking graphics and lightning-fast load times.",
    price: 599.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Gaming has never looked this good. The controller feedback is insane.",
  ...
  },
  {
    ...
    description:
      "Immersive ultrawide monitor perfect for gaming and multitasking.",
    price: 699.0,
    imageUrl: "https://picsum.photos/seed/monitor_ultrawide_34_main/600/400",
    gallery: ["https://picsum.photos/seed/monitor_ultrawide_34_a/800/600"],
    category: "Monitors",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Super smooth gameplay and tons of screen real estate for work.",
  ...
  },
  {
    ...
    description:
      "Tenkeyless mechanical keyboard with customizable switches and RGB lighting.",
    price: 129.99,
    ...
    reviews: [
      {
        ...
        author: "Quentin Beck",
        rating: 5,
        comment: "Typing feels amazing. Love the customization options.",
  ...
  },
  {
    ...
    description:
      "Pair of high-fidelity bookshelf speakers for accurate sound reproduction.",
    price: 450.0,
    imageUrl: "https://picsum.photos/seed/speakers_studio_set_main/600/400",
    gallery: ["https://picsum.photos/seed/speakers_studio_set_a/800/600"],
    category: "Audio",
    ...
    reviews: [
      {
        ...
        author: "Rachel Dawes",
        rating: 5,
        comment: "Crystal clear sound. Perfect for my home studio setup.",
      ...
      },
      {
        ...
        author: "Steve Rogers",
        rating: 4,
        comment: "Excellent detail, requires a good amplifier.",
  ...
  },
  {
    ...
    description:
      "Rugged and waterproof action camera capturing smooth 5K video.",
    price: 399.99,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Incredible stabilization, even in rough conditions. Very durable.",
        date: "2024-05-23T16:45:00Z",
      },
    ],
  },
  {
    ...
    name: "Feather Air M3",
    description:
      "Ultra-lightweight and thin laptop with exceptional battery life.",
    price: 1299.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Perfect for travel. The battery just keeps going!",
        date: "2024-05-27T10:20:00Z",
      },
      {
        id: "r15-2",
        author: "Victor Stone",
        rating: 4,
        comment:
          "Great build quality and performance for everyday tasks. Wish it had more ports.",
  ...
  // --- Start of 50 New Products ---
  {
    ...
    description:
      "Flagship killer smartphone with a focus on performance and fast charging.",
    price: 899.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Super smooth and fast. Charging is unbelievably quick.",
  ...
  },
  {
    ...
    description:
      "Fast and rugged portable solid-state drive for backups and file transfers.",
    price: 149.99,
    imageUrl: "https://picsum.photos/seed/ssd_portable_2tb_main/600/400",
    gallery: ["https://picsum.photos/seed/ssd_portable_2tb_a/800/600"],
    category: "Accessories",
    brand: "Samsonic",
    stock: 180,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Small, light, and incredibly fast. Perfect for video editing.",
  ...
  },
  {
    ...
    description:
      "Professional monitor calibrated for color accuracy, ideal for creative work.",
    price: 549.0,
    imageUrl: "https://picsum.photos/seed/monitor_proart_27_4k_main/600/400",
    gallery: ["https://picsum.photos/seed/monitor_proart_27_4k_a/800/600"],
    category: "Monitors",
    brand: "ASUS",
    stock: 55,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Colors are spot-on right out of the box. Great for photo editing.",
  ...
  },
  {
    ...
    description:
      "The ultimate tablet experience with the powerful M4 chip and stunning display.",
    price: 999.0,
    ...
    reviews: [
      {
        ...
        author: "Zoe Saldana",
        rating: 5,
        comment: "Insanely powerful and the display is incredible.",
  ...
  },
  {
    ...
    name: "AirPods Max",
    description:
      "Premium over-ear headphones with high-fidelity audio and adaptive EQ.",
    price: 549.0,
    imageUrl: "https://picsum.photos/seed/headphones_airpods_max_main/600/400",
    gallery: ["https://picsum.photos/seed/headphones_airpods_max_a/800/600"],
    category: "Audio",
    brand: "Pear Computers",
    stock: 70,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Amazing sound quality and build, but very expensive and heavy.",
  ...
  },
  {
    ...
    description:
      "Powerful gaming console with Quick Resume and a vast game library.",
    price: 499.0,
    ...
    reviews: [
      {
        ...
        author: "Bruce Banner",
        rating: 4,
        comment: "Game Pass is a game changer. Console is powerful and quiet.",
  ...
  },
  {
    ...
    description:
      "Convertible 2-in-1 laptop with a touch screen and pen support.",
    price: 899.99,
    imageUrl: "https://picsum.photos/seed/laptop_thinbook_flex_13_main/600/400",
    gallery: ["https://picsum.photos/seed/laptop_thinbook_flex_13_a/800/600"],
    category: "Laptops",
    brand: "Lenovo",
    stock: 70,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        author: "Clark Kent",
        rating: 4,
        comment: "Versatile and portable. Good for students.",
    ...
    reviews: [
      {
        ...
        author: "Diana Lance",
        rating: 5,
        comment: "Super cute and easy to use. Great for parties!",
  ...
  },
  {
    ...
    technicalSpecifications: {
      Ports:
        "4K HDMI, 100W PD USB-C, USB-C Data, USB-A 3.0 x2, USB-A 2.0, Ethernet, SD/microSD card reader, 3.5mm Audio",
    ...
    reviews: [
      {
        id: "r24-1",
        author: "Eric Lehnsherr",
        rating: 4,
        comment:
          "Works well, gets slightly warm but provides all the ports I need.",
  ...
  },
  {
    ...
    description:
      "Portable, rugged, and waterproof Bluetooth speaker with impressive sound.",
    price: 149.0,
    imageUrl: "https://picsum.photos/seed/speaker_soundlink_flex_main/600/400",
    gallery: ["https://picsum.photos/seed/speaker_soundlink_flex_a/800/600"],
    category: "Audio",
    brand: "SoundWave",
    stock: 120,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        author: "Frank Castle",
        rating: 5,
        comment: "Sounds way bigger than it looks. Takes a beating too.",
  ...
  },
  {
    ...
    name: "iPear 16 Pro",
    description:
      "The latest iPear with ProMotion display, advanced camera, and A18 Bionic chip.",
    price: 1099.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Fluid display and fantastic camera system. Ecosystem is seamless.",
  ...
  },
  {
    ...
    description:
      "Super ultrawide gaming monitor with Quantum Mini-LED technology.",
    price: 1999.99,
    ...
    reviews: [
      {
        ...
        author: "Hank Pym",
        rating: 5,
        comment: "Absolutely immersive gaming experience. The HDR is stunning.",
  ...
  },
  {
    ...
    description:
      "Simple, fast, and secure laptop running ChromeOS, perfect for web browsing and cloud apps.",
    price: 349.0,
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Great for basic tasks and very affordable. Boots up instantly.",
  ...
  },
  {
    ...
    name: "Webcam Pro 4K",
    description:
      "High-resolution webcam for professional video conferencing and streaming.",
    price: 199.0,
    imageUrl: "https://picsum.photos/seed/webcam_pro_4k_main/600/400",
    gallery: ["https://picsum.photos/seed/webcam_pro_4k_a/800/600"],
    category: "Accessories",
    brand: "Logitech",
    stock: 90,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        author: "Jean Grey",
        rating: 5,
        comment: "Sharp video quality and great performance in low light.",
        date: "2024-06-14T11:45:00Z",
      },
    ],
  },
  {
    ...
    description:
      "High-speed APS-C mirrorless camera, excellent for wildlife and sports photography.",
    price: 1499.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Incredibly fast autofocus and burst shooting. Perfect for capturing action.",
        date: "2024-06-15T16:20:00Z",
      },
    ],
  },
  {
    ...
    description:
      "The next generation of industry-leading noise-canceling headphones from Sorny.",
    price: 399.99,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Sorny does it again. The ANC is even better than the XM5s.",
  ...
  },
  {
    ...
    description:
      "Official wireless controller for the Switch console with HD rumble and NFC.",
    price: 69.99,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Comfortable and reliable. Much better than the Joy-Cons for long sessions.",
        date: "2024-06-17T12:15:00Z",
      },
    ],
  },
  {
    ...
    name: "Galaxy Tab S10",
    description:
      "Premium Android tablet with a beautiful AMOLED display and S Pen support.",
    price: 799.0,
    imageUrl: "https://picsum.photos/seed/tablet_galaxy_tab_s10_main/600/400",
    gallery: ["https://picsum.photos/seed/tablet_galaxy_tab_s10_a/800/600"],
    category: "Tablets",
    brand: "Samsonic",
    stock: 90,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Gorgeous screen and the S Pen is great for notes. Android tablet apps still lag behind iPadOS.",
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Love the compact size and the flipping camera is fun and useful.",
  ...
  },
  {
    ...
    description:
      "App-controlled LED strip to add ambient lighting to any room.",
    price: 29.99,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Easy setup and the app offers tons of customization. Looks great behind my TV.",
  ...
  },
  {
    ...
    price: 349.99,
    imageUrl:
      "https://picsum.photos/seed/monitor_curved_gaming_27_main/600/400",
    gallery: ["https://picsum.photos/seed/monitor_curved_gaming_27_a/800/600"],
    category: "Monitors",
    brand: "MSI",
    stock: 75,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r36-1",
        author: "Quicksilver Maximoff",
        rating: 4,
        comment:
          "Good value for a 165Hz QHD monitor. Colors are decent for a VA panel.",
  ...
  },
  {
    ...
    description:
      "Premium Windows laptop with a stunning InfinityEdge display and excellent build quality.",
    price: 1899.0,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "The display is absolutely breathtaking. Performance is solid.",
        date: "2024-06-22T13:20:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Compact and powerful portable speaker with improved sound and connectivity.",
    price: 129.95,
    imageUrl: "https://picsum.photos/seed/speaker_jbl_flip_7_main/600/400",
    gallery: ["https://picsum.photos/seed/speaker_jbl_flip_7_a/800/600"],
    category: "Audio",
    brand: "JBL",
    stock: 150,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        author: "Scott Lang",
        rating: 4,
        comment: "Great sound for its size, perfect for taking anywhere.",
  ...
  },
  {
    ...
    description:
      "Simple and compact hub to add more USB-A ports to your computer.",
    price: 12.99,
    ...
    reviews: [
      {
        ...
        author: "Susan Storm",
        rating: 5,
        comment: "Does exactly what it needs to do. Inexpensive and reliable.",
  ...
  },
  {
    ...
    description:
      "Hybrid full-frame camera with excellent video features and phase-detection AF.",
    price: 1997.99,
    ...
    reviews: [
      {
        id: "r40-1",
        author: "T'Challa Udaku",
        rating: 5,
        comment: "Finally, PDAF on a Lumix! Video features are top-notch.",
        date: "2024-06-25T09:10:00Z",
      },
    ],
  },
  {
    ...
    gallery: ["https://picsum.photos/seed/controller_elite_3_a/800/600"],
    category: "Gaming",
    brand: "Macrosoft",
    stock: 80,
    technicalSpecifications: {
      ...
      Features:
        "Interchangeable components, Adjustable-tension thumbsticks, Hair trigger locks, Rubberized grip",
    ...
    reviews: [
      {
        ...
        author: "Thor Odinson",
        rating: 5,
        comment: "Feels great in hand, tons of customization options.",
  ...
  },
  {
    ...
    description:
      "Affordable large-screen tablet for entertainment and light productivity.",
    price: 229.99,
    ...
    reviews: [
      {
        id: "r42-1",
        author: "Ulysses Klaue",
        rating: 4,
        comment: "Great screen for the price. Good for streaming video.",
  ...
  },
  {
    ...
    name: "Moto Edge+ (2024)",
    description:
      "Motorola flagship with a focus on display quality and clean software.",
    price: 799.99,
    imageUrl:
      "https://picsum.photos/seed/phone_moto_edgeplus_2024_main/600/400",
    gallery: ["https://picsum.photos/seed/phone_moto_edgeplus_2024_a/800/600"],
    category: "Smartphones",
    brand: "Motorola",
    stock: 70,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r43-1",
        author: "Valkyrie Brunnhilde",
        rating: 4,
        comment:
          "Beautiful display and smooth performance. Camera is good but not class-leading.",
        date: "2024-06-28T14:15:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Ergonomic aluminum laptop stand to improve posture and airflow.",
    price: 25.99,
    ...
    technicalSpecifications: {
      ...
      Features:
        "Adjustable height and angle, Foldable, Anti-slip silicone pads",
    },
    reviews: [
      {
        id: "r44-1",
        ...
        rating: 5,
        comment:
          "Sturdy and helps keep my laptop cool. Much more comfortable to type.",
  ...
  },
  {
    ...
    description:
      "27-inch QHD IPS gaming monitor with HDRi and built-in speakers.",
    price: 399.99,
    imageUrl:
      "https://picsum.photos/seed/monitor_benq_mobiuz_ex2710q_main/600/400",
    gallery: [
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Good image quality and the speakers are surprisingly decent for a monitor.",
        date: "2024-06-30T11:30:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Premium business ultrabook known for its durability and keyboard.",
    price: 1649.0,
    imageUrl:
      "https://picsum.photos/seed/laptop_thinkpad_x1_carbon_g12_main/600/400",
    gallery: [
    ...
    reviews: [
      {
        id: "r46-1",
        author: "Agent Coulson",
        rating: 5,
        comment: "Best keyboard on any laptop, period. Lightweight and tough.",
  ...
  },
  {
    ...
    description:
      "True wireless earbuds with active noise cancellation and spatial audio support.",
    price: 169.95,
    imageUrl:
      "https://picsum.photos/seed/earbuds_beats_studio_plus_main/600/400",
    gallery: [
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Good sound and ANC, comfortable fit. Seamless pairing with iPear.",
  ...
  },
  {
    ...
    description:
      "APS-C mirrorless camera designed specifically for vlogging and content creation.",
    price: 798.0, // Often bundled with kit lens
    imageUrl: "https://picsum.photos/seed/camera_zv_e10_main/600/400",
    gallery: ["https://picsum.photos/seed/camera_zv_e10_a/800/600"],
    category: "Cameras",
    brand: "Sorny",
    stock: 70,
    technicalSpecifications: {
      ...
      Video: "4K 30p",
      Features:
        "Product Showcase Setting, Background Defocus, Directional 3-Capsule Mic",
    },
    reviews: [
      {
        id: "r48-1",
        ...
        rating: 5,
        comment:
          "Makes vlogging so much easier. Autofocus is great for face tracking.",
  ...
  },
  {
    ...
    description:
      "Extended mouse pad providing ample space for mouse and keyboard.",
    price: 19.99,
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment: "Smooth surface, plenty of room. Simple and effective.",
        date: "2024-07-04T09:20:00Z",
      },
    ],
  },
  {
    ...
    price: 549.0,
    imageUrl:
      "https://picsum.photos/seed/handheld_steam_deck_oled_main/600/400",
    gallery: ["https://picsum.photos/seed/handheld_steam_deck_oled_a/800/600"],
    category: "Gaming",
    brand: "Valve",
    stock: 50,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r50-1",
        author: "Elektra Natchios",
        rating: 5,
        comment:
          "The OLED screen is a huge improvement. Great way to play PC games on the go.",
  ...
  },
  {
    ...
    description:
      "Digital notebook that feels like paper, designed for note-taking and reading.",
    price: 299.0,
    imageUrl: "https://picsum.photos/seed/tablet_remarkable_2_main/600/400",
    gallery: ["https://picsum.photos/seed/tablet_remarkable_2_a/800/600"],
    category: "Tablets",
    brand: "reMarkable",
    stock: 60,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r51-1",
        author: "Falcon Wilson",
        rating: 4,
        comment:
          "Amazing writing experience, truly feels like paper. Limited functionality beyond notes/PDFs.",
    ...
    reviews: [
      {
        ...
        author: "Groot Tree",
        rating: 4,
        comment: "I am Groot! (Translation: Cool design, software is clean.)",
  ...
  },
  {
    ...
    reviews: [
      {
        id: "r53-1",
        author: "Hope van Dyne",
        rating: 5,
        comment: "Convenient and declutters my nightstand.",
  ...
  },
  {
    ...
    description:
      "Versatile OLED display perfect as a small TV or large desktop monitor.",
    price: 1199.99,
    imageUrl: "https://picsum.photos/seed/monitor_lg_c4_42_oled_main/600/400",
    gallery: ["https://picsum.photos/seed/monitor_lg_c4_42_oled_a/800/600"],
    category: "Monitors",
    brand: "LG Electronics",
    stock: 40,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Incredible picture quality for gaming and movies. Perfect blacks.",
        date: "2024-07-09T16:30:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Lightweight and affordable Surface laptop for everyday tasks.",
    price: 799.99,
    imageUrl: "https://picsum.photos/seed/laptop_surface_go_3_main/600/400",
    gallery: ["https://picsum.photos/seed/laptop_surface_go_3_a/800/600"],
    category: "Laptops",
    brand: "Macrosoft",
    stock: 90,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Very portable and well-built for the price. Good for students or basic use.",
        date: "2024-07-10T11:15:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Open-back audiophile headphones renowned for their natural sound.",
    price: 599.95,
    imageUrl:
      "https://picsum.photos/seed/headphones_sennheiser_hd660s2_main/600/400",
    gallery: [],
    category: "Audio",
    brand: "Sennheiser",
    stock: 30,
    ...
    reviews: [
      {
        id: "r56-1",
        author: "Killmonger Erik",
        rating: 5,
        comment:
          "Incredible detail and soundstage. Requires a dedicated headphone amp.",
  ...
  },
  {
    ...
    description:
      "Full-frame mirrorless camera with a classic design and modern features.",
    ...
    reviews: [
      {
        ...
        author: "Luke Cage",
        rating: 5,
        comment: "Love the retro look and feel. Image quality is superb.",
  ...
  },
  {
    ...
    description:
      "High-capacity power bank with Power Delivery for fast charging laptops and phones.",
    price: 49.99,
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Charges my laptop and phone quickly. A bit heavy but expected for the capacity.",
        date: "2024-07-13T15:45:00Z",
      },
    ],
  },
  {
    ...
    gallery: ["https://picsum.photos/seed/console_switch_oled_a/800/600"],
    category: "Gaming",
    brand: "Nintendo",
    stock: 100,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r59-1",
        author: "Nebula Cyborg",
        rating: 5,
        comment:
          "The OLED screen makes a big difference. Great library of games.",
  ...
  },
  {
    ...
    name: "Lenovo Tab P12",
    description:
      "Large-screen Android tablet focused on entertainment and productivity.",
    price: 349.99,
    ...
    reviews: [
      {
        id: "r60-1",
        author: "Okoye General",
        rating: 4,
        comment: "Excellent large display for media consumption. Good value.",
  ...
  },
  {
    ...
    gallery: ["https://picsum.photos/seed/phone_fairphone_5_a/800/600"],
    category: "Smartphones",
    brand: "Fairphone",
    stock: 40,
    technicalSpecifications: {
      ...
      Camera: "50MP Main, 50MP Ultrawide",
      Features:
        "User-replaceable modules, 5-year warranty, 8 years software support",
    },
    reviews: [
      {
        id: "r61-1",
        author: "Professor Hulk",
        rating: 5,
        comment:
          "Love the repairability and long software support. Good enough performance.",
        date: "2024-07-16T13:30:00Z",
      },
    ],
  },
  {
    ...
    description:
      "Productivity monitor with 4K resolution, IPS Black technology, and extensive connectivity.",
    price: 619.99,
    imageUrl: "https://picsum.photos/seed/monitor_dell_u2723qe_main/600/400",
    gallery: ["https://picsum.photos/seed/monitor_dell_u2723qe_a/800/600"],
    category: "Monitors",
    brand: "Dell",
    stock: 80,
    technicalSpecifications: {
      ...
      Connectivity:
        "USB-C (90W PD, DP Alt Mode), HDMI, DisplayPort, USB Hub, RJ45 Ethernet",
    },
    reviews: [
      {
        id: "r62-1",
        ...
        rating: 5,
        comment:
          "Fantastic contrast for an IPS. The built-in hub is super convenient.",
  ...
  },
  {
    ...
    description:
      "Premium convertible laptop with a sleek design and OLED display option.",
    price: 1449.99,
    imageUrl:
      "https://picsum.photos/seed/laptop_hp_spectre_x360_14_main/600/400",
    gallery: ["https://picsum.photos/seed/laptop_hp_spectre_x360_14_a/800/600"],
    category: "Laptops",
    brand: "HP",
    stock: 50,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r63-1",
        author: "Shuri Princess",
        rating: 4,
        comment: "Stunning design and display. Keyboard is a bit shallow.",
  ...
  },
  {
    ...
    description:
      "Ergonomic office chair with breathable mesh back and adjustable lumbar support.",
    price: 299.0,
    ...
    technicalSpecifications: {
      ...
      Adjustability:
        "Lumbar Support, Armrests (Height/Width), Seat Depth, Tilt Lock",
      "Weight Capacity": "300 lbs",
    },
    reviews: [
      {
        id: "r64-1",
        author: "Star-Lord Quill",
        rating: 5,
        comment:
          "Super comfortable for long work sessions. Great adjustability.",
  ...
  },
  {
    ...
    description:
      "Compact smart speaker with room-filling stereo sound and voice control.",
    price: 249.0,
    imageUrl: "https://picsum.photos/seed/speaker_sonos_era100_main/600/400",
    gallery: ["https://picsum.photos/seed/speaker_sonos_era100_a/800/600"],
    category: "Audio",
    brand: "Sonos",
    stock: 90,
    technicalSpecifications: {
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Excellent sound for its size. App setup is easy. Wish it had Google Assistant.",
  ...
  },
  {
    ...
    description:
      "Capture immersive 8K 360 video with incredible stabilization.",
    price: 499.99,
    imageUrl: "https://picsum.photos/seed/camera_insta360_x4_main/600/400",
    gallery: ["https://picsum.photos/seed/camera_insta360_x4_a/800/600"],
    category: "Cameras",
    brand: "Insta360",
    stock: 65,
    technicalSpecifications: {
    ...
    reviews: [
      {
        id: "r66-1",
        author: "Vision Android",
        rating: 5,
        comment:
          "Amazing 360 capabilities and the software makes editing easy.",
